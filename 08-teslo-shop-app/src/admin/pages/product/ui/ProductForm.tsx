            ...
            <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-6">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  {
                    errors.title && (
                      <p className="text-red-500 text-sm">Title es requerido</p>
                    )
                  }
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    {
                      errors.price && (
                        <p className="text-red-500 text-sm">Precio debe ser mayor a 0</p>
                      )
                    }
                  </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    {...register('slug', {
                      required: true,
                      validate: (value: string) => !/\s/.test(value) || 'Slug no puede contener espacios en blanco'
                    })}
                    className={
                        cn("w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200", 
                          {
                  ...
                  />
                    {
                      errors.stock && (
                        <p className="text-red-500 text-sm">{errors.slug?.message || 'Slug es requerido'}</p>
                      )
                    }
                </div>
                ...
                <div>
                  ...
                  />
                    {
                      errors.stock && (
                        <p className="text-red-500 text-sm">Description requerida</p>
                      )
                    }
                </div>
              </div>
