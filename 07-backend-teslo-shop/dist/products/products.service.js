...
let ProductsService = class ProductsService {
    ...
    async findAll(paginationDto) {
        const { limit = 10, offset = 0, gender = '', minPrice, maxPrice, sizes, q: query, } = paginationDto;
        const sizesArray = sizes ? sizes.toUpperCase().split(',') : undefined;
        const priceWhere = minPrice !== undefined && maxPrice !== undefined
            ? (0, typeorm_2.Between)(minPrice, maxPrice)
            : minPrice !== undefined
                ? (0, typeorm_2.MoreThanOrEqual)(minPrice)
                : maxPrice !== undefined
                    ? (0, typeorm_2.LessThanOrEqual)(maxPrice)
                    : undefined;
        const products = await this.productRepository.find({
            ...
            where: {
                ...
                price: priceWhere,
                sizes: sizesArray ? (0, typeorm_2.ArrayContains)(sizesArray) : undefined,
                title: query ? (0, typeorm_2.ILike)(`%${query}%`) : undefined,
            },
        });
